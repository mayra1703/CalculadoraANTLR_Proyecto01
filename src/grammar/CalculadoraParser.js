	    ...
	    try {
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                switch(la_) {
	                case 1:
	                    localctx = new MultiParentesisContext(this, new ExprContext(this, _parentctx, _parentState));
...
CalculadoraParser.MultidivContext = MultidivContext;
...
CalculadoraParser.MasmenosContext = MasmenosContext;
...
CalculadoraParser.NumeroContext = NumeroContext;

class MultiParentesisContext extends ExprContext {
	...
	accept(visitor) {
	    if ( visitor instanceof CalculadoraVisitor ) {
	        return visitor.visitMultiParentesis(this);
	    } else {
	        return visitor.visitChildren(this);
	    }
	}
...
CalculadoraParser.MultiParentesisContext = MultiParentesisContext;
